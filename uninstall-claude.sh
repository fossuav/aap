...
for skill in boards find-code find-param build-options style-check hwdef-info hwdef-check explain build check autotest sitl lua lua-crsf lua-vehicle log-analyze aap-update; do
