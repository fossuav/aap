...
This file provides guidance for Lua scripts implementing CRSF (Crossfire) menus. For general script structure, see GEMINI.md.
...
Understanding the "why" behind the crsf_helper.lua design is critical to avoid reintroducing subtle bugs.
