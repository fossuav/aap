...
for file in SKILL.md log_extract.py flow_cal_check.py log_health.py thrust_check.py \
            gyro_fft.py rate_response.py filter_phase.py baro_thst_cal.py rate_band.py batch_fft.py \
            baro_health.py replay_sweep.py; do
...
chmod +x .claude/skills/log-analyze/log_extract.py .claude/skills/log-analyze/flow_cal_check.py \
    ...
    .claude/skills/log-analyze/baro_health.py \
    .claude/skills/log-analyze/replay_sweep.py
