...
- **Keep it to the size a maintainer writes.** Ten recent merged rmackay9 PRs run 47 to 447 words of prose, median 180, with no tables and at most a handful of bullets; seven of ours ran 471 to 3322, median 1126. Aim at 200 words of prose and treat 400 as the ceiling for a complex change; only the user-visible failure earns more than that, and 500 is the end of it. Past that the description is carrying something that belongs somewhere else.
