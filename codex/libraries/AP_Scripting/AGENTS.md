...
- `CODEX_VEHICLE_CONTROL.md` - Movement commands, controller behavior, state/telemetry, RC input
- `CODEX_CRSF_MENU.md` - CRSF (Crossfire) menu implementation with helper library
...
- `modules/` - Reusable Lua modules:
  - `crsf_helper.lua` - CRSF menu abstraction (see `CODEX_CRSF_MENU.md`)
