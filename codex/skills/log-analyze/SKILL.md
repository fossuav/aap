...
| "Source-set / failover recommendation" | See EKF source-set playbook note in `libraries/AP_NavEKF3/AGENTS.md` — source sets are manually switched, not automatic failover. Do not recommend `EK3_SRC2_*` as a "fallback" for glitch response. |
