#!/usr/bin/env python3
"""ArduPilot hwdef PR check helper for Codex.
...
def _has_tracked_changes():
    ...
    Deliberately ignores untracked files so that .codex/ (the skill's own
...
def cmd_prepare(args):
    ...
    if STATE_FILE.exists():
        ...
        sys.exit(
            ...
            f"`python3 .codex/skills/hwdef-check/hwdef_check.py restore` first."
        )
    ...
    print(f"When done, run `python3 .codex/skills/hwdef-check/hwdef_check.py restore`.")
